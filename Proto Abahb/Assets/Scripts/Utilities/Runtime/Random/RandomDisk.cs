...
namespace Utilities.Random
{
	public static class RandomDisk
	{
		...
		public static Vector2 Circle( ref MersenneTwister _rand, Random.Normalization n, float t )
		{
			float r;
			switch (n) {
		...
		public static Vector2 Disk( ref MersenneTwister _rand, Random.Normalization n, float temp )
		{
			double t, theta;
