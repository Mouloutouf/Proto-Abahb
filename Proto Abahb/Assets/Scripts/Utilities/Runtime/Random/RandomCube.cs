...
namespace Utilities.Random
{
	public static class RandomCube
	{
		...
		public static Vector3 Surface(ref MersenneTwister _rand, Random.Normalization n, float t)
		{
		...
		public static Vector3 Volume(ref MersenneTwister _rand, Random.Normalization n, float t)
		{
			float x, y, z;
			x = y = z = 0;
			switch (n) {
